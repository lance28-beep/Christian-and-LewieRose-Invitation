                ...
                {faqItems.map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <span className="font-[family-name:var(--font-crimson)] font-semibold text-[#292E41] pr-3 sm:pr-4 text-xs sm:text-sm md:text-base leading-relaxed group-hover:text-[#292E41]/80 transition-colors duration-200">
                          {item.question}
                        </span>
                        <ChevronDown
                          size={18}
                        ...
                        <div className="overflow-hidden">
                          <div className="px-3 sm:px-4 md:px-5 py-2.5 sm:py-3 md:py-4 border-t border-[#292E41]/20 bg-white/40">
                            {item.answer.includes("[RSVP_LINK]") ? (
                              <p className="text-[#292E41]/80 leading-relaxed text-xs sm:text-sm md:text-base font-[family-name:var(--font-crimson)] whitespace-pre-line">
                                {item.answer.split("[RSVP_LINK]")[0]}
                                <a
                                  href="#guest-list"
                                  className="text-[#292E41] underline font-semibold hover:text-[#292E41]/80 transition-colors inline-flex items-center gap-1"
                                  onClick={(e) => {
                                    e.preventDefault();
                                    document
