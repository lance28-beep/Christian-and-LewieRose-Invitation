...
export default async function GalleryPage() {
  ...
  return (
    <main className="min-h-screen bg-[#F1D3D3] relative overflow-hidden">
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-[family-name:var(--font-crimson)] font-normal text-[#292E41] mb-4 sm:mb-6 uppercase tracking-[0.1em] sm:tracking-[0.12em] elegant-text-shadow">
            Gallery
          </h1>
          <div className="flex items-center justify-center gap-2 mb-3 sm:mb-4">
            <div className="h-[1px] w-12 sm:w-16 md:w-24 bg-gradient-to-r from-transparent via-[#292E41] to-transparent" />
          </div>
          <p className="text-sm sm:text-base md:text-lg font-[family-name:var(--font-crimson)] text-[#292E41]/80 font-light max-w-xl mx-auto leading-relaxed tracking-wide px-2">
            A collection from our favorite moments
          </p>
        </div>

        {images.length === 0 ? (
          <div className="text-center text-[#292E41]/80">
            <p className="text-sm sm:text-base font-[family-name:var(--font-crimson)]">No images found. Add files to <code className="px-2 py-1 bg-white/60 rounded border border-[#292E41]/30 text-[#292E41]">public/gallery</code>.</p>
          </div>
        ) : (
